...
L["Log entries to show in death log (reduce if game crashes)"] = "Записи журнала, которые нужно отобразить в журнале смертей (уменьшить, если игра вылетает)"
...
L["ui:filters:select-cds"] = "Выбрать CDs..."
